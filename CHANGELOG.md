...
- `hkust_nxt_dual/`：重写 README、`串口映射.md`、`uXRCE端口.md`，改为引用快照的方法论文档。
- `general/`：新增 `PX4_uXRCE_DDS话题配置.md`，同时更新 `文档索引.md`。
...
- docs：迁移 `general/` 下的基线文章（MAVLink Shell、PX4 与 Nuttx 架构、TFmini 数据流、USB/CDC/NSH 教程等），建立手册主体内容。

## 2025-12-03
- `hkust_nxt_dual/串口映射.md`：记录 USART2/TELEM1 控制台提速的说明，方便串口调试时设置 115200 以上带宽。
